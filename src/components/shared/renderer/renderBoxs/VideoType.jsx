...
function VideoType({list=[], title}) {
  ...
  return (
    <div className='my-10'>
        ...
        <div className='bg-zinc-600 mb-6 w-full  max-h-[360px]'>
            {
                selectedVideo &&
                <iframe className='w-full h-[360px]' allowFullScreen="1"  src={`https://www.youtube.com/embed/${selectedVideo.videoId}?origin=*`} data-title="video_title" title="video_title" frameBorder="0"></iframe>
            }
        </div>
        {
            list.length>1 &&
